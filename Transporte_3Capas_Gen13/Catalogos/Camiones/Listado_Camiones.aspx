<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Listado_Camiones.aspx.cs" Inherits="Transporte_3Capas_Gen13.Catalogos.Camiones.Listado_Camiones" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
        <div class="container">
            <div class="row">
                <h3>Listado de Camiones</h3>
                <p>
                    <asp:Button ID="Insertar" runat="server" Text="Agregar" CssClass="btn btn-primary" Width="85px" OnClick="Insertar_Click"/>
                </p>
            </div>
            <div class="row">
